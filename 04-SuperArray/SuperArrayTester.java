public class SuperArrayTester{
  public static void main(String[] args) {
    ...
    try{
      ...
      ans = list2.indexOf("one");
      if(!(ans == 0)){
        result=false;
        System.out.println("indexOf(\"one\") got: "+ans);
      }

      ans = list2.indexOf("fish");
      if(!(ans == 1)){
        result=false;
        System.out.println("indexOf(\"fish\") got: "+ans);
      }

      ans = list2.indexOf("blue");
      if(!(ans == 6)){
        result=false;
        System.out.println("indexOf(\"blue\") got: "+ans);
      }

      ans = list2.indexOf("not here");
      if(!(ans == -1)){
        result=false;
        System.out.println("indexOf(\"not here\") got: "+ans);
      }

      //

      ans = list2.lastIndexOf("one");
      if(!(ans == 0)){
        result=false;
        System.out.println("lastIndexOf(\"one\") got: "+ans);
      }

      ans = list2.lastIndexOf("fish");
      if(!(ans == 7)){
        result=false;
        System.out.println("lastIndexOf(\"fish\") got: "+ans);
      }

      ans = list2.lastIndexOf("blue");
      if(!(ans == 6)){
        result=false;
        System.out.println("lastIndexOf(\"blue\") got: "+ans);
      }

      ans = list2.lastIndexOf("not here");
      if(!(ans == -1)){
        result=false;
        System.out.println("lastIndexOf(\"not here\") got: "+ans);
      }
