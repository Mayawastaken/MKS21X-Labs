public class SuperArrayExceptionTester{
  ...
  public static void main(String[] args) {
    ...
    list = init();
    try{
        list.set(-1, "please have an exception");
        System.out.println(testNum+". FAIL! No exception thrown "+testName);
    }catch(IndexOutOfBoundsException e){
      System.out.println(testNum+". PASS "+testName);
    }
    ...
    list = init();
    try{
        list.set(list.size(), "please have an exception");
        System.out.println(testNum+". FAIL! No exception thrown "+testName);
    }catch(IndexOutOfBoundsException e){
      System.out.println(testNum+". PASS "+testName);
    }
    ...
    list = init();
    try{
        list.add(-1, "please have an exception");
        System.out.println(testNum+". FAIL! No exception thrown "+testName);
    }catch(IndexOutOfBoundsException e){
      System.out.println(testNum+". PASS "+testName);
    }
    ...
    list = init();
    try{
        list.add(list.size()+1, "please have an exception");
        System.out.println(testNum+". FAIL! No exception thrown "+testName);
    }catch(IndexOutOfBoundsException e){
      System.out.println(testNum+". PASS "+testName);
    }
    ...
    testNum++;
    testName = "SuperArray constructor illegal argument -1";
    try{
